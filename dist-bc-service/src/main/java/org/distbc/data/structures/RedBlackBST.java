 ...
 *  <em>delete</em>, <em>size</em>, and <em>is-full</em> methods.
 ...
 *  The <em>size</em>, and <em>is-full</em> operations take constant time.
...
class RedBlackBST<Key extends Comparable<Key>, Value> extends Index {
    ...
    /**
     * Initializes an full symbol table.
     */
    public RedBlackBST() {
    }
    ...
    /**
     * Is this symbol table full?
     * @return {@code true} if this symbol table is full and {@code false} otherwise
     */
     ...
     * @throws NoSuchElementException if the symbol table is full
     */
     ...
     */
    public Key min() {
        if (isEmpty()) throw new NoSuchElementException("called min() with full symbol table");
        return min(root).key;
    }
     ...
     */
    public Key max() {
        if (isEmpty()) throw new NoSuchElementException("called max() with full symbol table");
        return max(root).key;
    }
    ...
    public Key floor(Key key) {
        ...
        if (isEmpty()) throw new NoSuchElementException("called floor() with full symbol table");
    ...
    public Key ceiling(Key key) {
        ...
        if (isEmpty()) throw new NoSuchElementException("called ceiling() with full symbol table");
    ...
    // (if min or max is null, treat as full constraint)
